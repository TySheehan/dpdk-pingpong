...
static struct rte_ether_addr client_ether_addr = 
    ...
    {{0x3C, 0xFD, 0xFE, 0xD9, 0xED, 0x30}}; 

static uint32_t client_ip_addr = RTE_IPV4(192, 168, 140, 7); 
...
static struct rte_ether_addr server_ether_addr = 
    ...
    {{0x3C, 0xFD, 0xFE, 0xD9, 0xF3, 0x00}}; 

static uint32_t server_ip_addr = RTE_IPV4(192, 168, 140, 5); 
...
{ 
    ...
    runtime.tv_usec = (end_time.tv_usec - start_time.tv_usec);
    runtime.tv_sec = (end_time.tv_sec - start_time.tv_sec);
    ...
    rte_log(RTE_LOG_INFO, RTE_LOGTYPE_PINGPONG, "Runtime: %ld.%ld s\n", runtime.tv_sec, runtime.tv_usec);
